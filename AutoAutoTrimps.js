...
function workerRatios() {
    if (game.resources.trimps.realMax() > 50000000) {
        ...
        autoTrimpSettings.FarmerRatio.value = '1';
        autoTrimpSettings.LumberjackRatio.value = '1';
        autoTrimpSettings.MinerRatio.value = '99';
        }
...
//BEGIN AUTOMAPS DECISIONS:
    ...
    if (!game.global.preMapsActive && game.global.mapsActive) {
        ...
        if (selectedMap == game.global.currentMapId && (!getCurrentMapObject().noRecycle && (game.global.mapBonus < 9 || shouldFarm || stackingTox || needPrestige ||mapYouSlow || shouldDoSpireMaps)) || (repeatBionics && addSpecials(true, true, getCurrentMapObject()) > 0)) {
