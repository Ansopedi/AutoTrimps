...
function autoStance() {
    ...
    if (game.global.mapsActive && (getCurrentEnemy(1).name == "Jestimp" || getCurrentEnemy(1).name == "Chronoimp" ||  (hiderwindow > (960*0.12/mutations.Corruption.statScale(10)) && getCurrentMapObject().location != "Void"))){ setFormation(4); return;}
    if (game.global.mapsActive && (getCurrentEnemy(1).name != "Jestimp" && getCurrentEnemy(1).name != "Chronoimp" &&  (hiderwindow < (960*0.12/mutations.Corruption.statScale(10)) && getCurrentMapObject().location != "Void"))){ setFormation(2); return;}
