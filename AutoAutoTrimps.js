...
function autoStance() {
    ...
    if (game.global.mapsActive && (getCurrentEnemy(1).name == "Jestimp" || getCurrentEnemy(1).name == "Chronoimp" ||  (hiderwindow > (960*0.12/mutations.Corruption.statScale(10)/(game.global.titimpLeft>0?2:1)) && getCurrentMapObject().location != "Void"))){ setFormation(4); return;}
    if (game.global.mapsActive && (getCurrentEnemy(1).name != "Jestimp" && getCurrentEnemy(1).name != "Chronoimp" &&  (hiderwindow < (960*0.12/mutations.Corruption.statScale(10)/(game.global.titimpLeft>0?2:1)) && getCurrentMapObject().location != "Void"))){ setFormation(2); return;}
...
function autoGoldenUpgrades() {
    ...
    if (game.global.world>=569&&game.global.world<=7771){
